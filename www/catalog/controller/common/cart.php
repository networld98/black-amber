...
class ControllerCommonCart extends Controller {
    public function index() {
        ...
        foreach($this->cart->getProducts() as $giftItem){
            if($giftItem['gift_summa'] == '0'){
                $giftInCart = $giftItem['product_id'];
            }
        }
        foreach($this->cart->getProducts() as $cartItem){
            if($cartItem['product_id'] == $giftInCart && $totals[0]['value']<$this->getConfigSumm()[0]['price']){
        ...
        $data['giftSumm'] = $this->getConfigSumm()[0]['price'];
