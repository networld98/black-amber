...
class ControllerCheckoutGuest extends Controller {
	public function index() {
        ...
        $data['shipping_method_post'] = $_POST['shipping_method'];
...
//                }
//            }
            if($_POST['shipping_method']=='novaposhta.novaposhta') {
                if ((utf8_strlen(trim($this->request->post['city'])) < 2) || (utf8_strlen(trim($this->request->post['city'])) > 128)) {
                    $json['error']['city'] = $this->language->get('error_city');
                }
            }

            if($_POST['shipping_method']=='flat.flat') {
                $data['address_1'] = $this->session->data['payment_address']['address_2'];
                $data['city'] = $this->session->data['payment_address']['address_1'];
            }
			$this->load->model('localisation/country');
