...
//Костыль по полям
        ...
        if (isset($this->request->post['config_custom_field_1'])) {
            $data['config_custom_field_1'] = $this->request->post['config_custom_field_1'];
        } else {
            $data['config_custom_field_1'] = $this->config->get('config_custom_field_1');
        }

        if (isset($this->request->post['config_custom_field_2'])) {
            $data['config_custom_field_2'] = $this->request->post['config_custom_field_2'];
        } else {
